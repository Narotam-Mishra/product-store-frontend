...
const Home = () => {
  ...
  return (
    <div className="p-4">
      <div className="flex justify-center items-center gap-x-4" style={{width:"20%", marginLeft:"37%"}}>
        <button
      ...
      <div className="flex justify-between items-center">
        {showType === "table" ? (
          <h1 className="text-3xl my-8 mx-auto">Products Table View</h1>
        ) : (
          <h1 className="text-3xl my-8 mx-auto">Products Card View</h1>
        )}
        <Link to={"/product/add"}>
